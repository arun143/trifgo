...
import 'package:sixam_mart/features/premium/domain/repositories/premium_repository.dart';
import 'package:sixam_mart/features/premium/domain/repositories/premium_repository_interface.dart';
import 'package:sixam_mart/features/premium/domain/services/premium_service.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  PremiumRepositoryInterface premiumRepositoryInterface = PremiumRepository(sharedPreferences: Get.find(), apiClient: Get.find());
  Get.lazyPut(() => premiumRepositoryInterface);
  ...
  PremiumServiceInterface premiumServiceInterface = PremiumService(premiumRepositoryInterface: Get.find());
  Get.lazyPut(() => premiumServiceInterface);
  ...
  Get.lazyPut(() => PremiumPayController(premiumServiceInterface: Get.find()));
