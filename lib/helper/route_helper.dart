...
import 'package:sixam_mart/features/premium/screens/premium_screen.dart';
...
import 'package:sixam_mart/features/subscription/controllers/subscription_controller_binding.dart';
import 'package:sixam_mart/features/subscription/screens/my_subscription_screen.dart';
...
class RouteHelper {
  ...
  static String getPickMapRoute1(String page) => '$accessLocation?page=$page';
  ...
  static String getPremiumRoute() => premium;
...
//Subscription
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: premium, page: () => getRoute(const PremiumScreen())),
