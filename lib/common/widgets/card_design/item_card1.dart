...
class ItemCard1 extends StatelessWidget {
  ...
  final int? index;
  const ItemCard1({super.key, required this.item, this.isPopularItem = false, required this.isFood, required this.isShop, this.isPopularItemCart = false, this.index});
                        ...
                        child: Stack(clipBehavior: Clip.none, children: [
                          ...
                          Align(
                            ...
                            child: Column(
                              ...
                              (isFood || isShop) ? Text(item.name ?? '', style: robotoBold, maxLines: 2, overflow: TextOverflow.ellipsis):
