                  ...
                  Container(
                    ...
                    child: Column(children: [
                      PortionWidget(
                        ...
                        hideDivider: Get.find<SplashController>().configModel!.premiumStatus == 1  ? false : true,
                      ),
                      (Get.find<SplashController>().configModel!.premiumStatus == 1) && AuthHelper.isLoggedIn() ? PortionWidget(
                        icon: Images.pointIcon, title: 'Premium'.tr,
                        route: RouteHelper.getPremiumRoute(),
