...
import 'package:sixam_mart/common/widgets/custom_image_widget.dart';
import 'package:sixam_mart/common/widgets/custom_snackbar_widget.dart';
...
import 'package:sixam_mart/helper/price_converter_helper.dart';
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child:  Row(children: [
                      ...
                      Text(""
                        //PriceConverterHelper.convertPrice(subscriptionController.profileModel!.phone),
                        //style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault),
                      ),
                ...
                child: !subscriptionController.isLoading ? CustomButtonWidget(
                  onPressed: () {
                    if(!subscriptionController.isSelect && !subscriptionController.isDigitalPaymentSelect){
                      ...
                      subscriptionController.renewBusinessPlan(storeId: subscriptionController.profileModel!.userInfo!.id.toString(), isCommission: package.id == -1);
                    }
                  },
