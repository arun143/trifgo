...
class AddPremiumDialogueWidget1 extends StatefulWidget {
  final ScrollController cardScrollController;
  const AddPremiumDialogueWidget1({super.key, required this.cardScrollController});

  @override
  State<AddPremiumDialogueWidget1> createState() => _AddPremiumDialogueWidgetState();
}

class _AddPremiumDialogueWidgetState extends State<AddPremiumDialogueWidget1> {
  ...
  void _onAddFundButtonClicked(PremiumPayController premiumPayController) {
     if(premiumPayController.digitalPaymentName == ''){
      ...
      double amount =  Get.find<SplashController>().configModel!.premium1Rate!.toDouble();
