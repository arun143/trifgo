...
class AddView1 extends StatelessWidget {
  const AddView1({super.key});
    ...
    return GetBuilder<BannerController>(builder: (bannerController) {
      return  Container(
        ...
        child: ClipRRect(
          borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
          child: CustomImage(
            image: 'https://trifgo.in/storage/app/public/promotional_banner/2025-02-17-67b350f477665.png',
