              ...
              child: Column(
                children: [
                  parcel ? Column(children: [
                   ...
                   //
                    (order.serviceCharge != null && order.serviceCharge! > 0) ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text(Get.find<SplashController>().configModel!.serviceChargeName!, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                      Text('(+) ${PriceConverter.convertPrice(order.serviceCharge)}', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall), textDirection: TextDirection.ltr),
                    ]) : const SizedBox(),
                    (order.serviceCharge != null && order.serviceCharge! > 0) ? const SizedBox(height: 10) : const SizedBox(),
//
                    (order.storeCharge != null && order.storeCharge! > 0) ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text('Store Charges'.tr,  style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                      Text('(+) ${PriceConverter.convertPrice(order.storeCharge)}', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall), textDirection: TextDirection.ltr),
                    ]) : const SizedBox(),
                    (order.storeCharge != null && order.storeCharge! > 0) ? const SizedBox(height: 10) : const SizedBox(),
