...
class AppConstants {
  static const String appName = 'TrifGo';
  static const double appVersion = 2.13; ///Flutter Version: 3.24.5

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://trifgo.in';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://trifgo.in';
  ...
  static const String addPremiumUri = '/api/v1/customer/wallet/add-premium';
  ...
  static const String adsContentUri = '/api/v1/other-banners/adds';
  ...
  /// Subscription url
  static const String goldPackagesUri = '/api/v1/package-view';
  static const String gbusinessPlanUri = '/api/v1/business_plan';
  static const String gbusinessPlanPaymentUri = '/api/v1/gsubscription/payment/api';
  static const String cancelGoldSubscriptionUri = '/api/v1/gcancel-subscription';
  static const String GoldsubscriptionTransactionUri = '/api/v1/gsubscription-transaction';
  static const String checkProductLimitsUri = '/api/v1/gcheck-order-limits';
